...
scheduler.add_job(lambda: set_monitor_state("off"), 'cron', hour=18, minute=8)  # Turn off at 10:00 PM
scheduler.add_job(lambda: set_monitor_state("on_rotate_left"), 'cron', hour=8, minute=00)   # Turn on at 7:00 AM
scheduler.start()
